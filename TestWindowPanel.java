import java.awt.*;
	...
	public class TestWindowPanel extends JPanel implements ActionListener, PropertyChangeListener
	{
	   ...
	   static int cnt; // ProgressCounter - counts the current amount of files that have been already transferred 
	   static int fcnt;// fileCount - this is the total number of files to be transferred 
	   ...
	   class Task extends SwingWorker<Void,Void>
	   {
		   ...
		   {
			   file_acc.fileAmtCheck(new File(fd.toString()));
			   file_acc.fileMove(new File(fd.toString()), new File(td.toString()));
			   return null;
	     ...
	     addPropertyChangeListener(this);
	           ...
	           public void actionPerformed(ActionEvent event)
	        {
	            if(event.getSource() == browsefbtn){
	                ...
	                int returnVal = filechoose.showOpenDialog(TestWindowPanel.this);
	            ...
	            if(event.getSource() == backup)
	                {
	            	 file_acc.fileAmtCheck(new File(fd.getText().toString()));
	    ...
	    public static void main(String[] args){
	        ...
	        TestWindowPanel panel = new TestWindowPanel();
